                        ...
                        <div key={internship._id} className="internship-list-card">
                            <div className="card-top-row">
                                <div className="card-titles">
                                    ...
                                    <p className="company-name">{internship.company || 'Unknown Company'}</p>
                                </div>
                            ...
                            <div className="card-meta-row">
                                ...
                                <div className="meta-item">
                                    <Package size={16} />
                                    <span>{internship.type || 'Onsite'}</span>
                                </div>
                            </div>
                    ...
                    <div className="modal-content" style={{ background: 'white', padding: '2rem', borderRadius: '12px', width: '90%', maxWidth: '500px', position: 'relative' }}>
                        ...
                        {applySuccess ? (
                            ...
                            <form onSubmit={handleApplySubmit}>
                                ...
                                <p style={{ color: '#64748b', marginBottom: '1.5rem', fontSize: '0.9rem' }}>{selectedInternship.company}</p>
