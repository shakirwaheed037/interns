    ...
    return (
        <div className="companies-page-wrapper">
            ...
            <div className="industry-tags-container">
                <div className="industry-tags-label">Filter by Industry:</div>
                <div className="industry-tags">
                    {industries.map((industry, index) => (
                        <button
                            key={index}
                            className={`industry-tag ${selectedIndustry === industry ? 'active' : ''}`}
                ...
                <div className="company-modal-overlay" onClick={() => setIsModalOpen(false)}>
                    <div className="company-modal-content" onClick={e => e.stopPropagation()}>
                        ...
                        <div className="modal-header-flex">
                            <img src={selectedCompany.logo || companyImg} alt="Logo" className="modal-logo" />
